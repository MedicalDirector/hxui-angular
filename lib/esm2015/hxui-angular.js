...
class DatepickerComponent {
    ...
    renderCalendar() {
        for (let /** @type {?} */ i = 0; i <= this.cellCount; i++) {
            ...
            let /** @type {?} */ date = new Date(this.viewDate.getFullYear(), this.viewDate.getMonth());
            // Shifts the week to start from Monday, rather than Sunday, this causes the index to start at 1
            let /** @type {?} */ dayOffset = date.getDay() == 0 ? 7 : date.getDay();
...
/** @nocollapse */
TabularOrderByService.ctorParameters = () => [];
...
/** @nocollapse */
SelectizeModule.ctorParameters = () => [];
