(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@angular/common'), require('rxjs/operators'), require('rxjs'), require('@angular/platform-browser'), require('@angular/http'), require('@angular/router'), require('lodash')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/forms', '@angular/common', 'rxjs/operators', 'rxjs', '@angular/platform-browser', '@angular/http', '@angular/router', 'lodash'], factory) :
	(factory((global.hxui = global.hxui || {}, global.hxui.angular = {}),global.ng.core,global.ng.forms,global.ng.common,global.Rx.Observable.prototype,global.rxjs,global.ng.platformBrowser,global.ng.http,global.ng.router,global.lodash));
}(this, (function (exports,core,forms,common,operators,rxjs,platformBrowser,http,router,lodash) { 'use strict';
