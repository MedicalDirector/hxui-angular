      ...
      <div class="ngb-tp">
        <div class="ngb-tp-input-container ngb-tp-hour">
          <button *ngIf="spinners" tabindex="-1" type="button" (click)="changeHour(hourStep)"
            class="hx-button is-flat" [class.is-small]="isSmallSize" [class.is-large]="isLargeSize" [class.disabled]="disabled"
            [disabled]="disabled">
            <span class="hx-icon icon-angle-up is-medium is-info"></span>
            <span class="sr-only is-hidden" i18n="@@ngb.timepicker.increment-hours">Increment hours</span>
          </button>
          <div class="hx-input-control">
          <input type="text" class="hx-input is-text-center" [class.is-small]="isSmallSize"
            ...
            (keydown.ArrowDown)="changeHour(-hourStep); $event.preventDefault()" hxaTextInput>
            <label class="hx-label"></label>
            <div class="hx-help"></div>
          </div>
          <button *ngIf="spinners" tabindex="-1" type="button" (click)="changeHour(-hourStep)"
            class="hx-button is-flat mt-2" [class.is-small]="isSmallSize" [class.is-large]="isLargeSize" [class.disabled]="disabled"
            [disabled]="disabled">
            <span class="hx-icon icon-angle-down is-medium is-info"></span>
            <span class="sr-only is-hidden" i18n="@@ngb.timepicker.decrement-hours">Decrement hours</span>
          </button>
        </div>
        ...
        <div class="ngb-tp-input-container ngb-tp-minute">
          <button *ngIf="spinners" tabindex="-1" type="button" (click)="changeMinute(minuteStep)"
            ...
            [disabled]="disabled">
            <span class="hx-icon icon-angle-up is-medium is-info"></span>
            <span class="sr-only is-hidden" i18n="@@ngb.timepicker.increment-minutes">Increment minutes</span>
          </button>
          <div class="hx-input-control">
          <input type="text" class="hx-input is-text-center" [class.is-small]="isSmallSize" [class.is-large]="isLargeSize"
          ...
          <button *ngIf="spinners" tabindex="-1" type="button" (click)="changeMinute(-minuteStep)"
            ...
            [disabled]="disabled">
            <span class="hx-icon icon-angle-down is-medium is-info"></span>
            <span class="sr-only is-hidden"  i18n="@@ngb.timepicker.decrement-minutes">Decrement minutes</span>
          </button>
        </div>
        <div *ngIf="seconds" class="ngb-tp-spacer">:</div>
        <div *ngIf="seconds" class="ngb-tp-input-container ngb-tp-second">
          <button *ngIf="spinners" tabindex="-1" type="button" (click)="changeSecond(secondStep)"
            class="hx-button is-flat" [class.btn-sm]="isSmallSize" [class.btn-lg]="isLargeSize" [class.disabled]="disabled"
            [disabled]="disabled">
            <span class="hx-icon icon-angle-up is-medium is-info"></span>
            <span class="sr-only is-hidden" i18n="@@ngb.timepicker.increment-seconds">Increment seconds</span>
          </button>
          <div class="hx-input-control">
          <input type="text" class="hx-input is-text-center" [class.is-small]="isSmallSize" [class.is-large]="isLargeSize"
          ...
          <button *ngIf="spinners" tabindex="-1" type="button" (click)="changeSecond(-secondStep)"
            class="hx-button mt-2" [class.is-small]="isSmallSize" [class.is-large]="isLargeSize"  [class.disabled]="disabled"
            [disabled]="disabled">
            <span class="hx-icon icon-angle-down is-medium is-info"></span>
            <span class="sr-only is-hidden" i18n="@@ngb.timepicker.decrement-seconds">Decrement seconds</span>
          </button>
        </div>
        <div *ngIf="meridian" class="ngb-tp-spacer"></div>
        <div *ngIf="meridian" class="ngb-tp-meridian">
          <button type="button" class="hx-button mb-1" [class.is-small]="isSmallSize" [class.is-large]="isLargeSize"
...
export class Timepicker implements ControlValueAccessor,
  ...
  constructor(
      private readonly _config: TimepickerConfig, private _ngbTimeAdapter: HxaTimeAdapter<any>,
      private _cd: ChangeDetectorRef, public i18n: TimepickerI18n) {
  ...
  writeValue(value) {
    ...
    this.model = structValue ? new HxaTime(structValue.hour, structValue.minute, structValue.second) : new HxaTime();
