...
export class TypeaheadDirective implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    if (this.typeaheadAsync === undefined && !(this.hxa_typeahead instanceof Observable)) {
      this.typeaheadAsync = false;
    }

    if (this.hxa_typeahead instanceof Observable) {
  ...
  protected syncActions(): void {
    this.keyUpEventEmitter.pipe(
      ...
      mergeMap((value: string) => {
        ...
        return from(this.hxa_typeahead).pipe(
          filter((option: any) => {
