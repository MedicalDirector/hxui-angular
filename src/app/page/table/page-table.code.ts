...
export class PageTableCode {
  usage: Code = {
    lang: ['ts'],
    text: `import { TabularModule } from "@hxui-angular";
...
`,
  ...
  egKitchenHTML: Code = {
    lang: ['xml'],
    text: `<div class="hx-toolbar is-small is-perforated">
  <span
