...
export class PageSelectCode {
  install: Code = {
    lang: ['sh'],
    text: `npm install @ng-select/ng-select @hxui/ng-select --save`,
  };

  import: Code = {
    lang: ['scss'],
    text: `@import "@hxui/ng-select/themes/hxui.theme.scss"`,
  };

  usage: Code = {
    lang: ['ts'],
    text: `import { NgSelectModule } from '@ng-select/ng-select';
...
import { MyFeatureService } from './path/to/service';
...
export class MyFeatureComponent implements OnInit {
  ...
  constructor(
    private _dataService: MyFeatureService, 
...
`,
  ...
  egMultiTS: Code = {
    ...
    text: `import { Component, OnInit } from '@angular/core';
import { Observable } from 'rxjs';
import { MyFeatureService } from './data.service';
...
export class MyFeatureService {
  ...
  getPhotos() {
    return this._http.get<any[]>('https://jsonplaceholder.typicode.com/photos');
  }
